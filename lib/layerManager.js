...
LayerManager.prototype.adjustToContainer = function() {
  this._width = parseInt(window.getComputedStyle(this._domElement.parentNode).width,10);
  this._height = parseInt(window.getComputedStyle(this._domElement.parentNode).height,10);
